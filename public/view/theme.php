...
<main class="min-h-dvh"> 
    ...
    <hr class="ng-[#565857] pt-4">
    <!-- ----------------------------------------------- -->

    <section class="flex flex-col justify-center items-start gap-2.5 lg:gap-7">
        <h2 class="font-bold text-2xl pl-3.5    lg:text-4xl lg:pt-30">Bonjour,<?= $_SESSION["pseudo"] ?> !</h2>
        <p class="text-2xl text-center px-2 py-2 lg:text-3xl">Choisissez un thème et commencez votre quiz</p>
    </section>
    <!-- ############################################################################################# -->
